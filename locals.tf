locals {
  service_delegation_actions = {
    ...
    # "Microsoft.App/testClients" = ["virtualNetworks/subnets/join/action"] # Need Microsoft.Network/AllowInternalDelegations
    ...
    # "Microsoft.Codespaces/plans" = ["virtualNetworks/subnets/join/action"] # InvalidServiceNameOnDelegation
    ...
    # "Microsoft.Orbital/orbitalGateways" = ["publicIPAddresses/join/action", "virtualNetworks/subnets/join/action", "virtualNetworks/read", "publicIPAddresses/read"] # InvalidServiceNameOnDelegation
